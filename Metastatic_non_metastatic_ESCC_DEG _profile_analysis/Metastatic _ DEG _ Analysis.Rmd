...
res_lfc1 <- results(dds, lfcThreshold = 1)
class(res_lfc1)
summary(res)
summary(res_lfc1)
...
# Filter out genes with significant l2fc (padj < 0.05)
padj_0.05 <- res_lfc1$padj < 0.05
res_lfc1_padj <- res_lfc1[padj_0.05, ]
res_lfc1_padj
#
dim(res_lfc1_padj)
dim(res_lfc1)
#
summary(res_lfc1_padj)

order(res_lfc1_padj$padj, decreasing = T)
res_lfc1_padj_ord <- res_lfc1_padj[order(res_lfc1_padj$padj, decreasing = F), ]
head(res_lfc1_padj_ord)
